#!/usr/bin/env python3
"""
🏆 Adobe India Hackathon 2025 - Collection 3 F1 Score Calculator
Calculate F1 Score, Precision, and Recall for Collection 3 Food Contractor processor
...
class Collection3F1Calculator:
    def __init__(self, debug: bool = False):
        ...
        if self.debug:
            print("🔍 Collection 3 F1 Score Calculator initialized")
    
    def calculate_f1_score(self, 
                          generated_file: str = "collection3_output.json",
                          expected_file: str = "challenge1b_output.json") -> Dict[str, float]:
        """
    ...
    def _calculate_precision_recall(self, 
        ...
        matched_expected = set()  # Track which expected items have been matched
        ...
        for gen_item in generated:
            ...
            if best_match:
                ...
                matched_expected.add(id(best_match))
                if self.debug:
...
def main():
    parser = argparse.ArgumentParser(description="Calculate F1 score for Collection 3")
    parser.add_argument("--debug", action="store_true", help="Enable debug output")
    parser.add_argument("--generated", default="collection3_output.json", 
                       help="Path to generated output file")
    parser.add_argument("--expected", default="challenge1b_output.json",
                       help="Path to expected output file")
    
    args = parser.parse_args()
    
    calculator = Collection3F1Calculator(debug=args.debug)
    
    print("🔍 Calculating F1 Score for Collection 3...")
    ...
    print("\n" + "="*60)
    print("📊 COLLECTION 3 EVALUATION RESULTS")
    print("="*60)

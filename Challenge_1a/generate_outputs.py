...
# Generate outputs for all PDF files
...
for pdf_file in pdf_files:
    ...
    try:
        result = process_pdf_for_hackathon(f'sample_dataset/pdfs/{pdf_file}')
        output_file = f'model_outputs/{pdf_file.replace(".pdf", ".json")}'
...
print("\\nAll outputs generated! Now running official evaluation...")

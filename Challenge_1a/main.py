#!/usr/bin/env python3
"""
PDF Title and Heading Extraction Tool
Adobe Hackathon 2025 - Challenge 1a

This tool processes PDF files and extracts:
1. Document titles with high accuracy
2. Hierarchical outline/headings with optimized F1-score

Features:
- Dynamic font analysis (no hardcoding)
- Advanced text grouping for phrase completion
- Precision-focused heading detection
- Adaptive thresholds based on document characteristics

Performance: F1-Score: 47.3%, Recall: 91.4%, Precision: 31.9%
"""
...
class PDFProcessor:
    """
    Optimized PDF processor for maximum F1-score
    """
...
def main():
    ...
    parser = argparse.ArgumentParser(description='PDF Title and Heading Extractor')
    ...
    processor = PDFProcessor(debug=args.debug)
